...
exports.getBlock = function(bytesIn,start,end,mode)
{
	if(end - start > 16)
		end = start + 16;
 ...
 */
exports.encrypt = function (bytesIn, mode, key, iv)
{
	var size = key.length;
	if(iv.length%16)
	{
 ...
 * iv - the 128 bit number array Initialization Vector
 */
exports.decrypt = function(cipherIn,mode,key,iv)
{
	var size = key.length;
	if(iv.length%16)
	{
...
exports.padBytesIn = function(data) {
	var len = data.length;
...
exports.unpadBytesOut = function(data) {
	var padCount = 0;
	var padByte = -1;
	var blockSize = 16;
